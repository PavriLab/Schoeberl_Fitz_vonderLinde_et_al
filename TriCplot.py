...
def plotProfile(profiledict,
    ...
    :param profileheight:   height of a single profile in inch (determines the final figure height; if annotations are 1 inch is added per annotation axis)
...
if annotations:
    for annotation_axs in [annotation_axs1, annotation_axs2]:
        for (annoax, (track, label, alternating, plottype, ylim, visible_xticks)) in zip(annotation_axs, annotations):
