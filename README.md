...
```bash
python3 TriC/TriC_matrix_simple_MO.py -f CCseqmatrixfile -c chr14 -l 105550000 -r 105866000 -b 2000 -t 80 -a -o folder
```
...
python3 TriC/TriC_matrix_simple_MO.py -f CCseqmatrixfile \
                                      -c chr14 -l 105550000 -r 105866000 \
                                      --normchrom chr14 --nstr 105550000 --nstp 105866000 \
                                      -b 2000 \
                                      -t 50 \
                                      -a \
                                      -o TriCplots
